...
export function useQuizState(quizId: string, totalQuestions: number, durationMinutes: number = 15) {
  ...
  const jobsData = [
    ...
    },
    {
      ...
      description: "Design and optimize high-performance distributed systems handling millions of concurrent requests with 99.99% uptime SLAs.",
      type: "Full-time",
      location: "Remote",
      deadline: new Date("2027-01-30"),
      qualifications: "5+ years backend experience with systems-level programming, microservices architecture, and performance optimization.",
      requiredSkills: "Go, Rust, or C++, Distributed Systems, PostgreSQL",
      preferredSkills: "gRPC, Message Queues, Kubernetes, Observability",
      vacancies: 1
    },
    {
      recruiterId: rec2.id,
      title: "Mobile App Developer (Flutter)",
      description: "Develop cross-platform mobile applications for iOS and Android with beautiful responsive UIs and real-time synchronization.",
      type: "Full-time",
      location: "Bangalore / Remote",
      deadline: new Date("2026-12-30"),
      qualifications: "B.Tech/B.E. in CS/IT with strong experience building production Flutter applications.",
      requiredSkills: "Dart, Flutter, Mobile UI/UX, State Management",
      preferredSkills: "Firebase, REST APIs, Git, App Publishing",
      vacancies: 2
    },
    {
      recruiterId: rec1.id,
      title: "Mobile Developer Intern (React Native)",
      description: "Build cross-platform mobile apps using React Native, collaborate with product team, and ship features to production.",
      type: "Internship",
      location: "Pune / Hybrid",
      deadline: new Date("2026-11-05"),
      qualifications: "Final year student with JavaScript/React fundamentals and interest in mobile development.",
      requiredSkills: "JavaScript, React, React Native, CSS",
      preferredSkills: "Redux, Navigation Libraries, Mobile Testing",
      vacancies: 2
    },
    {
      recruiterId: rec2.id,
      title: "DevOps & Infrastructure Engineer",
      description: "Manage cloud infrastructure on AWS/GCP, implement CI/CD pipelines, monitoring dashboards, and infrastructure-as-code automation.",
      type: "Full-time",
      location: "Bangalore / Hybrid",
      deadline: new Date("2027-01-15"),
      qualifications: "B.Tech/B.E. graduate with expertise in containerization, orchestration, and cloud platforms.",
      requiredSkills: "Docker, Kubernetes, Terraform, Bash/Python",
      preferredSkills: "AWS/GCP, Prometheus, ELK Stack, Jenkins",
      vacancies: 2
    },
    {
      recruiterId: rec1.id,
      title: "Database Engineer (SQL/NoSQL)",
      description: "Design optimized database schemas, performance tuning, replication strategies, and backup automation for mission-critical systems.",
      type: "Full-time",
      location: "Remote",
      deadline: new Date("2026-12-25"),
      qualifications: "Strong expertise in relational databases (PostgreSQL/MySQL) and NoSQL (MongoDB/Cassandra).",
      requiredSkills: "SQL, Database Design, Query Optimization, Performance Tuning",
      preferredSkills: "PostgreSQL, MongoDB, Redis, Database Administration",
      vacancies: 1
    },
    {
      recruiterId: rec2.id,
      title: "Mechanical Engineer - Design & CAD",
      description: "Design mechanical components, create 3D models, perform FEA simulations, and collaborate with manufacturing teams.",
      type: "Full-time",
      location: "Pune / On-site",
      deadline: new Date("2026-12-20"),
      qualifications: "B.E./B.Tech in Mechanical Engineering with proficiency in CATIA, SolidWorks, or Fusion 360.",
      requiredSkills: "CAD Design, FEA Analysis, Technical Drawings, Mechanical Engineering",
      preferredSkills: "MATLAB, GD&T, Sheet Metal Design, Assembly",
      vacancies: 3
    },
    {
      recruiterId: rec1.id,
      title: "Mechanical Engineer - Thermal Systems",
      description: "Work on thermal management systems, HVAC design, heat exchanger optimization, and energy efficiency improvements.",
      type: "Internship",
      location: "Chennai / Hybrid",
      deadline: new Date("2026-10-20"),
      qualifications: "Final year Mechanical Engineering student with knowledge of thermodynamics and fluid mechanics.",
      requiredSkills: "Thermodynamics, Fluid Mechanics, MATLAB, Technical Analysis",
      preferredSkills: "CFD, ANSYS, Heat Transfer, Energy Systems",
      vacancies: 2
    },
    {
      recruiterId: rec2.id,
      title: "Electrical Power Systems Engineer",
      description: "Design power distribution networks, conduct load flow analysis, oversee substation automation and grid modernization projects.",
      type: "Full-time",
      location: "Hyderabad / On-site",
      deadline: new Date("2026-12-30"),
      qualifications: "B.E./B.Tech in Electrical Engineering with background in power systems and industrial experience.",
      requiredSkills: "Power Systems, Control Systems, MATLAB/Simulink, Electrical Design",
      preferredSkills: "ETAP, PSSE, Renewable Energy Integration, SCADA",
      vacancies: 2
    },
    {
      recruiterId: rec1.id,
      title: "Control Systems Engineer",
      description: "Develop control algorithms, PLC programming, and real-time embedded control systems for industrial automation.",
      type: "Full-time",
      location: "Bangalore / Hybrid",
      deadline: new Date("2027-01-10"),
      qualifications: "B.E./B.Tech in ECE/EEE with expertise in control theory and PLC programming.",
      requiredSkills: "Control Theory, PLC Programming, MATLAB/Simulink, Embedded Systems",
      preferredSkills: "Ladder Logic, Industrial Protocols, Real-time Systems",
      vacancies: 1
    },
    {
      recruiterId: rec2.id,
      title: "Civil Engineer - Structural Design",
      description: "Perform structural analysis, design RC buildings, bridges, and conduct site inspections for compliance and safety.",
      type: "Full-time",
      location: "Mumbai / On-site",
      deadline: new Date("2026-12-15"),
      qualifications: "B.E./B.Tech in Civil Engineering with hands-on experience in structural design software.",
      requiredSkills: "Structural Analysis, AutoCAD, Building Codes, Reinforced Concrete Design",
      preferredSkills: "ETABS, SAFE, Revit, Foundation Design",
      vacancies: 2
    },
    {
      recruiterId: rec1.id,
      title: "Civil Engineer - Infrastructure Intern",
      description: "Support infrastructure projects from conceptual design to execution, handle surveys, site coordination, and documentation.",
      type: "Internship",
      location: "Delhi / On-site",
      deadline: new Date("2026-11-15"),
      qualifications: "Final year Civil Engineering student with basic CAD skills and site experience.",
      requiredSkills: "AutoCAD, Site Surveying, Technical Documentation, Construction Knowledge",
      preferredSkills: "BIM, Project Management, Cost Estimation",
      vacancies: 4
    },
    {
      recruiterId: rec2.id,
      title: "Quality Assurance & Testing Engineer",
      description: "Design automated test suites using Selenium/Cypress, perform regression testing, and ensure product quality standards.",
      type: "Full-time",
      location: "Bangalore / Hybrid",
      deadline: new Date("2027-01-20"),
      qualifications: "B.Tech/B.E. with expertise in QA automation, manual testing, and test case design.",
      requiredSkills: "Selenium, Testing Frameworks, SQL, Manual Testing",
      preferredSkills: "Cypress, Jest, CI/CD Integration, Test Management",
      vacancies: 3
    },
    {
      recruiterId: rec1.id,
      title: "QA Automation Intern",
      description: "Learn test automation, write test cases, perform API testing, and contribute to improving software quality.",
      type: "Internship",
      location: "Pune / Hybrid",
      deadline: new Date("2026-11-25"),
      qualifications: "Final year student with basic programming knowledge and interest in software testing.",
      requiredSkills: "Programming Basics, Testing Concepts, Attention to Detail",
      preferredSkills: "Selenium, API Testing, Test Frameworks",
      vacancies: 3
    },
    {
      recruiterId: rec2.id,
      title: "Business Analyst & Product Specialist",
      description: "Gather requirements, create user stories, analyze market trends, and drive product roadmap decisions.",
      type: "Full-time",
      location: "Remote",
      deadline: new Date("2026-12-10"),
      qualifications: "Any engineering background with strong analytical skills and business acumen.",
      requiredSkills: "Requirements Analysis, Data Analysis, Communication, Business Acumen",
      preferredSkills: "SQL, Tableau, Agile Methodology, Market Research",
      vacancies: 2
    },
    {
      recruiterId: rec1.id,
      title: "Technical Recruiter - Engineering Roles",
      description: "Source and recruit talented engineers, conduct technical screening, and build talent pipelines for various tech roles.",
      type: "Full-time",
      location: "Bangalore / Hybrid",
      deadline: new Date("2027-01-05"),
      qualifications: "Any graduate with experience in technical recruiting and understanding of engineering roles.",
      requiredSkills: "Recruitment, Communication, Technical Understanding, CRM Tools",
      preferredSkills: "LinkedIn Sourcing, ATS, Negotiation, Employer Branding",
      vacancies: 2
    },
    {
      recruiterId: rec2.id,
      title: "Java Backend Developer",
      description: "Develop scalable microservices using Spring Boot, design REST APIs, and implement enterprise software solutions.",
      type: "Full-time",
      location: "Bangalore / Hybrid",
      deadline: new Date("2026-12-20"),
      qualifications: "B.Tech/B.E. in CS/IT with strong Java and Spring Boot experience.",
      requiredSkills: "Java, Spring Boot, SQL, REST APIs",
      preferredSkills: "Microservices, Docker, Kafka, Hibernate",
      vacancies: 3
    },
    {
      recruiterId: rec1.id,
      title: "Java Developer Intern",
      description: "Build backend services, learn Spring Boot framework, and contribute to enterprise application development.",
      type: "Internship",
      location: "Hyderabad / Hybrid",
      deadline: new Date("2026-11-30"),
      qualifications: "Final year student with Java programming knowledge and interest in backend development.",
      requiredSkills: "Java, OOP, SQL Basics, Problem Solving",
      preferredSkills: "Spring Framework, REST APIs, Git",
      vacancies: 4
    },
    {
      recruiterId: rec2.id,
      title: "AI/ML Research Scientist",
      description: "Conduct cutting-edge research in deep learning, publish papers, and develop novel AI models for production deployment.",
      type: "Full-time",
      location: "Bangalore / Remote",
      deadline: new Date("2027-02-28"),
      qualifications: "M.Tech/Ph.D. in AI/ML/CS with published research papers and strong mathematical foundation.",
      requiredSkills: "Machine Learning, Deep Learning, Python, Research Methodology",
      preferredSkills: "PyTorch/TensorFlow, NLP, Computer Vision, Academic Publishing",
      vacancies: 1
    }
  ];
